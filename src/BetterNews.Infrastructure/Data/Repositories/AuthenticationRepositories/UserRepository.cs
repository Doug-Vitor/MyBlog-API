...
public class UserRepository : IUserRepository
{
    ...
    public UserRepository(AuthenticationContext context, IUsersRolesRepository usersRolesRepository) => (_context, _usersRolesRepository) = (context, usersRolesRepository);
    ...
    public async Task<int?> SignInAsync(SignInUserModel signInModel) => 
        (await _context.Users.FirstOrDefaultAsync(prop => prop.Username == signInModel.Username && prop.PasswordHash == signInModel.Password.ToHash()))?.Id ?? throw new SignInFailException();
